...
const api = axios.create({
  baseURL: 'https://pure-retreat-95713.herokuapp.com'
});
...
api.interceptors.request.use(req => {
  ...
  if (
    ...
    req.url.includes('front/v1/wish_items') ||
    req.url.includes('auth/v1/user') ||
    req.url.includes('front/v1/contacts') ||
    req.url.includes('front/v1/checkouts') 
  ) {
